...
const FooterDoc = () => {
  return(
      <footer className="mt-[70vh] sm:mt-10 h-[15rem] w-screen bg-amber-700 flex flex-row sm:p-10 p-2">
          <article className="flex flex-col w-1/2">
              ...
              <nav className="my-5 flex items-center justify-center">
                  <div className="h-8 w-[8rem] flex flex-row justify-center items-center ml-1">
                      <a href="https://github.com/markbakos" target="_blank" rel="noopener noreferrer"
                      ...
                      <a href="mailto:markbakosss@gmail.com" className="text-gray-400 hover:text-white mr-2">
                      ...
                      <a href="https://www.linkedin.com/in/markbakos/" target="_blank"
                         rel="noopener noreferrer" className="text-gray-400 hover:text-white mr-2">
                      ...
                      <a href="https://www.instagram.com/187mrk" target="_blank" rel="noopener noreferrer"
                         className="text-gray-400 hover:text-white mr-2">
                          <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 448 512"
                               height="24" width="24" xmlns="http://www.w3.org/2000/svg">
                              <path
